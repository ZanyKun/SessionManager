...
public class DbUtil{
	//Start of application: Keep 50 open connections in a pool
			...
			static{
				ds.setUrl(DbPropertyUtil.getUrl());
				ds.setUsername(DbPropertyUtil.getUsername());
				ds.setPassword(DbPropertyUtil.getPassword());
				ds.setDefaultAutoCommit(false);
				ds.setDriverClassName(DbPropertyUtil.getDriver()); //by-default set as per the driver library in classpath
